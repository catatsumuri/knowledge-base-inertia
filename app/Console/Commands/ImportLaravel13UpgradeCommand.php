...
class ImportLaravel13UpgradeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'markdown:laravel13-upgrade';
     ...
     * @var string
     */
    protected $description = 'Import database/laravel13/upgrade.md into laravel13/upgrade.';
    ...
    {
        $sourcePath = base_path('database/laravel13/upgrade.md');
        $slug = 'laravel13/upgrade';
        $folderPath = 'laravel13';
        $folderLabel = 'Laravel 13';
        ...
        $resolveTitleAndBody = static function (string $body): array {
            ...
            return ['Laravel 13 アップグレードガイド', $body];
        };
        ...
        $this->info('Imported laravel13/upgrade.');
