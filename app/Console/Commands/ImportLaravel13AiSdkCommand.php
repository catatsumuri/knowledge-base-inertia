...
class ImportLaravel13AiSdkCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'markdown:laravel13-ai-sdk';
     ...
     * @var string
     */
    protected $description = 'Import database/laravel13/ai-sdk.md into laravel13/ai-sdk.';
    ...
    {
        $sourcePath = base_path('database/laravel13/ai-sdk.md');
        $slug = 'laravel13/ai-sdk';
        ...
        $this->info('Imported laravel13/ai-sdk.');
